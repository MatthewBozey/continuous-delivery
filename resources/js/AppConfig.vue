      ...
      <div class="grid free-themes">
        <div class="col-3 text-center">
          <button
              ...
              type="button"
              @click="
                            changeTheme($event, 'bootstrap4-light-blue', false)
                        "
          >
            <img
                class="block"
        ...
        <div class="col-3 text-center">
          <button
              ...
              type="button"
              @click="
                            changeTheme($event, 'bootstrap4-dark-blue', true)
                        "
          >
            <img
                class="block"
        ...
        <div class="col-3 text-center">
          <button
              ...
              type="button"
              @click="
                            changeTheme($event, 'bootstrap4-dark-purple', true)
                        "
          >
            <img
                class="block"
      ...
      <div class="grid free-themes">
        ...
        <div class="col-3 text-center">
          <button
              ...
              type="button"
              @click="
                            changeTheme($event, 'md-light-deeppurple', false)
                        "
          >
            <img
                class="block"
      ...
      <div class="grid free-themes">
        ...
        <div class="col-3 text-center">
          <button
              ...
              type="button"
              @click="
                            changeTheme($event, 'mdc-light-deeppurple', false)
                        "
          >
            <img
                class="block"
        ...
        <div class="col-3 text-center">
          <button
              ...
              type="button"
              @click="
                            changeTheme($event, 'mdc-dark-deeppurple', true)
                        "
          >
            <img
                class="block"
...
export default {
  ...
  methods: {
    ...
    changeTheme(event, theme, dark) {
      // this.$emit('theme-change', { theme: theme, dark: dark });
      event.preventDefault();
    },
  },
  computed: {
